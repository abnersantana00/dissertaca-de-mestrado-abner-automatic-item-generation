...
Este capítulo apresenta uma visão geral do trabalho, abordando a motivação e contextualização, a caracterização do problema, os objetivos (geral e específicos), as questões de pesquisa, a metodologia de pesquisa, as contribuições esperadas e a organização desta dissertação. 
