...
\section{Problema}
muitos alunos enfrentam desafios como a falta de motivação, as altas taxas de reprovação, o que ressalta a necessidade de ferramentas de treino e avaliação eficientes (Mbiada et al, 2022). Nos cursos introdutórios de programação, a prática de pequenas tarefas e questionários é essencial para alcançar a proficiência em programação, No entanto, a criação desses questionários é um processo demorado e sujeito a erros, e a avaliação dessas tarefas com feedback detalhado é vital para o aprendizado (Zalava e Mendonza, 2018)
