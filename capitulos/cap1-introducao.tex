...
O objetivo deste trabalho é desenvolver um sistema inteligente para geração automática de  questões de programação, capaz de criar questões diversificadas e contextualizadas a partir de templates multicamadas, e com o auxilio da Inteligencia Artificial Generativa para diversificar o contexto das questões e fornecer feedback detalhado em tempo real aos estudantes. 
