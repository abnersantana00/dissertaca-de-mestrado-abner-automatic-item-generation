...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|p{10cm}|}
        \hline
        \textbf{Questão de Referência} & Um e-commerce deseja aplicar descontos automáticos para incentivar vendas. Dependendo do valor total do carrinho, diferentes faixas de desconto serão aplicadas. Escreva um programa que receba o valor total da compra de um cliente e utilize estruturas condicionais (\texttt{if-else}) para determinar o desconto aplicado: \\ 
        & \begin{itemize}
            \item Se o valor for inferior a R\$ 100,00, não há desconto.
            \item Se o valor estiver entre R\$ 100,00 e R\$ 299,99, aplicar 5\% de desconto.
            \item Se o valor for igual ou superior a R\$ 300,00, aplicar 10\% de desconto.
        \end{itemize}
        Após calcular o desconto, exiba o valor final da compra e a economia obtida. \\ \hline
        \textbf{Enunciado (Stem)} & \texttt{\{contexto-geral\} \{contexto-específico\} \{tabela-condicional\} \{solicitação\}} \\ \hline
        \textbf{Elementos} & Texto \\ \hline
    \end{tabular}
    \caption{Descrição de Questões e Elementos (Autoria Própria, 2024)}
