...
\input{fixos/Pacotes.tex} %inclusão de pacotes usados no documento
\input{editaveis/Variaveis.tex} %definição de variáveis (linguagem usada, espaçamento para assinatura, etc.)
\input{fixos/Informacoes.tex} %nome do programa e texto do preâmbulo

% \input{fixos/ufrnComandos}
% \input{fixos/configuracoes.tex}
\input{editaveis/Informacoes.tex} %Informações sobre o trabalho, autor e orientador(es)

\input{fixos/NovosComandos.tex} % Definição de novos comandos para diagramação de capa, folha de rosto, etc.
...
%\fancypagestyle{plain}
  ...
  \input{editaveis/FolhaDeAprovacao.tex}
...
%  \textual
  ...
  % Capitulo 1: Introdução
   \input{capitulos/cap1-introducao.tex}

  % Capitulo 2: Metodologia
   \input{capitulos/cap2-metodologia.tex}

  % Capitulo 3: Floats
  % %\input{capitulos/Cap3_Floats.tex}


  % Capitulo 3: Trabalhos Relacionados
   %\input{capitulos/cap3-trabalhos-relacionados.tex}

   % Capitulo 4: Fundamentação Teórica
 \input{capitulos/cap4-fundamentacao-teorica}

  % Capitulo 4: Quarto capítulo (arquivo capitulos/capitulo4.tex)
  %\input{capitulos/Cap4_Matematica.tex}


% Capitulo 5: Proposta Conceitual
\input{capitulos/cap5-proposta-conceitual.tex}

  % Capitulo 5: Quinto capítulo (arquivo capitulos/capitulo5.tex)
  %\input{capitulos/Cap5_DesenhosAnimacoes.tex}


% Capitulo 5: Proposta de ferramenta
\input{capitulos/cap6-proposta-de-ferramenta}
  
  % Capitulo 6: Sexto capítulo (arquivo capitulos/capitulo6.tex)
  %\input{capitulos/Cap6_Correcoes.tex}


% Capitulo 7: Estudo de Caso
\input{capitulos/cap7-estudo-de-caso}

  % Capitulo 7: Sétimo capítulo (arquivo capitulos/capitulo7.tex)
   %\input{capitulos/Cap7_Referencias.tex}
   
  % Capitulo 7: Considerações Finais
\input{capitulos/cap8-consideracoes-finais}
  % Capitulo 8: Oitavo capítulo (arquivo capitulos/capitulo7.tex)
  %\input{capitulos/Cap8_Glossario.tex}
  
  % Consideracoes finais
  %\input{capitulos/Cap9_ConsideracoesFinais.tex}
